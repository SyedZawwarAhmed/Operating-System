...
def print_process_table(process_list):
    table = Texttable()
    table_rows = [["process_id", "arrival_time", "burst_time", "completion_time",
                   "turn_around_time", "wait_time", "response_time", "utilization_time"]]
...
def print_process_average_table(process_list):
    ...
    average_response_time = mean(
        [process.response_time for process in process_list])
